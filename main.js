...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Enquiry Form Submission API logic
    ...
    if (enquiryForm) {
        enquiryForm.addEventListener('submit', async (e) => {
            ...
            // Show loading state
            btn.disabled = true;
            btn.textContent = currentLang === 'hi' ? 'भेज रहा हूँ...' : currentLang === 'bn' ? 'পাঠানো হচ্ছে...' : 'Sending...';
            ...
            try {
                ...
                formStatus.classList.remove('hidden', 'error', 'success');
    ...
    navLinks.querySelectorAll('a').forEach(link => {
        link.addEventListener('click', (e) => {
            // Only close menu if it's active
            if (navLinks.classList.contains('active')) {
        ...
        items.forEach((product, index) => {
            ...
            card.innerHTML = `
                <div class="product-image">
                    ...
                    ${product.featured ? `<span class="product-badge">${currentLang === 'hi' ? 'विशेष रूप' : currentLang === 'bn' ? 'ফিচারড' : 'Featured'}</span>` : ''}
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            btn.disabled = true;
            btn.textContent = currentLang === 'hi' ? 'साइन इन हो रहा है...' : currentLang === 'bn' ? 'সাইন ইন হচ্ছে...' : 'Signing in...';
            
            setTimeout(() => {
                const successMsg = currentLang === 'hi' ? 'सफलता! डैशबोर्ड पर पुनर्निर्देशित किया जा रहा है (नकली)' : 
                                 currentLang === 'bn' ? 'সফল হয়েছে! ড্যাশবোর্ডে রিডাইরেক্ট করা হচ্ছে (সিমুলেটেড)' : 
                                 'Success! Redirecting to dashboard (Simulated)';
                alert(successMsg);
                btn.disabled = false;
